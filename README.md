...
One of the core feature is that it lets you run server side javascript.

2. Understand and explain the use of Middleware.

Middleware is a way to write code that could be resued in routing and validating requests.

3. The basic principles of the REST architectural style.

REST i used by most servers to group requests into four methods: GET, POST, DELETE, and PUT

4. Understand and explain the use of Express Routers.

Express Routers are middlewares that we can use to group traffic to specific endpoints.

5. Describe tooling used to manually test the correctness of an API.

We could use Httpie or Postman to test the API.
